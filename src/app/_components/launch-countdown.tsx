...
const LaunchCountdown = () => {
  ...
  return (
    <div className=" relative flex flex-col items-center justify-center h-[65%] w-full">
      <Image
        alt="GTA VI Banner"
        src="/gta6-banner.png"
        fill
      ...
      <div className="absolute top-1/3 text-white flex flex-col items-center">
        <h3 className="text-4xl font-bold">GTA VI está chegando!</h3>
        <p className="text-xl">
          Prepare-se para o lançamento mais aguardado dos games
        </p>

        <div className="flex mt-6 gap-5 justify-center items-center min-w-[300px]">
        ...
        <Button variant="ghost" className="mt-5 w-1/2 text-lg bg-pink-600">
          Saiba mais
        </Button>
      </div>
    </div>
