...
const TeamCard = ({ params }: TeamCardProps) => {
  return (
    <Card className="flex h-[600px] w-90 flex-col overflow-hidden border-1 border-purple-700 p-0 dark:bg-gray-800">
      <CardContent className="flex h-full flex-col items-center p-0 text-center">
        ...
        {/* Links sociais */}
        <div className="mt-auto flex justify-center space-x-4 pb-4 dark:text-white">
